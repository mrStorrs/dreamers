...
Invoke Forge (follow `~/.claude/dreamers/refs/delegation.md`). Pass Forge:
- The list of changed files from Step 1
- The rule source: `~/.claude/dreamers/refs/comment-rules.md` — those are the authoritative rules
